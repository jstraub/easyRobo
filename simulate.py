...
if __name__ == '__main__':
  ...
  if scenario == 'sam':
    ...
    robo = Mapping_Robo(x0,ScanerSensor(50,toRad(90),toRad(1.0),zCov))
    world = GridWorld2D(400,400,uCov)
    world.world[150:250,150] = 100
    world.world[150:250,250] = 100
    world.world[150,150:250] = 100
    world.world[250,150:250] = 100
